...
export const ticketStyleEnum = pgEnum('ticket_style_enum', [
  'coupon',
  'event',
  'storeCard',
  'generic',
...
export const passTypes = pgTable(
  'pass_types',
  {
...
export const registrations = pgTable(
  ...
  (table) => {
    return {
      ...
      deviceActiveIdx: index('idx_registrations_device_active').on(
        table.deviceLibraryIdentifier,
        table.active
      ),
      passRef: foreignKey({
