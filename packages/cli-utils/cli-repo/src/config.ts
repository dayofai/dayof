...
export function readVercelConfig(): VercelProjectsConfig {
	...
	const candidates = [
		resolve(packageRoot, "vercel-projects.json"), // packages/cli-utils/cli-repo/vercel-projects.json
		resolve(cwd, "packages", "cli-utils", "cli-repo", "vercel-projects.json"), // cwd/packages/cli-utils/cli-repo/vercel-projects.json
